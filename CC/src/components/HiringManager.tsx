        ...
        >
          ...
          <ul className="space-y-4">
            {features.map((feature, index) => (
              ...
              >
                <span className="bg-magenta text-white rounded-full w-8 h-8 flex items-center justify-center mr-3">
                  {index + 1}
                </span>
          ...
          <p className="text-xl text-gray-700 mt-8 mb-8">
            ...
            <span className="text-magenta font-semibold"> high-quality candidates </span>
            through the networks of
            <span className="text-magenta font-semibold"> thousands of SWE professionals.</span>
          </p>
          ...
          >
            <Link href="/hiring-manager/ScheduleTimeToChat">
              <span className="inline-flex items-center bg-transparent border-2 border-magenta text-magenta py-3 px-6 focus:outline-none hover:bg-magenta hover:text-white rounded-full text-lg transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
                Schedule a Chat
              </span>
            </Link>
          </motion.div>
