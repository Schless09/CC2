...
const HMItems = () => {
  return (
    <>
      ...
      <CarouselItem>
        <motion.section
          className="relative specialization-section py-16 px-6 md:px-12 rounded-2xl bg-gradient-to-br from-pink-100 via-white to-purple-50 shadow-2xl overflow-hidden"
          {...fadeIn}
        >
      ...
      {/* About Section */}
        <CarouselItem>
          <motion.section
            className="about-section flex flex-col justify-center items-center py-10 md:py-16 px-4 md:px-12 rounded-xl h-full bg-gradient-to-br from-purple-100 via-white to-pink-50 shadow-2xl relative"
            {...fadeIn}
          >
            {/* Background Image */}
            <div
      ...
      <CarouselItem>
        <motion.section
          className="locations-section flex flex-col justify-center items-center py-16 px-6 md:px-12 rounded-2xl h-full bg-gradient-to-r from-gray-50 to-pink-100 shadow-2xl relative"
          {...fadeIn}
        >
          <div className="absolute top-0 left-0 w-full h-full opacity-10 pointer-events-none">
          ...
          <div className="relative z-10 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 w-full">
            {keyMarkets.map((city, index) => (
              <motion.div
                key={index}
                className="city-item bg-white p-6 rounded-xl shadow-md text-center hover:bg-pink-50 hover:shadow-lg transform transition duration-300"
      ...
      <CarouselItem>
        <motion.section
          className="choose-us-section flex flex-col justify-center items-center py-16 px-6 md:px-12 rounded-2xl h-full bg-gradient-to-b from-purple-50 to-gray-50 shadow-2xl relative"
          {...fadeIn}
        >
